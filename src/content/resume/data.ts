	...
	workExperiences: [
		{
			...
			descriptions: [
				...
				"As a Senior Software Engineer, I contributed to the migration of the backend from a single-database system to a multi-database SaaS architecture using NestJS, Golang, and AWS, and worked closely with the team to deliver features efficiently.",
